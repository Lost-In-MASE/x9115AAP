...
* ![The REP has also improved the running time of the experiment when compared to SVM used for retrieval.] (https://github.com/Lost-In-MASE/x9115AAP/tree/master/hw/read/1/images/Running_time.png)
